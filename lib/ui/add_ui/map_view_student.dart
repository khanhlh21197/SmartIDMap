...
class MapViewStudent extends StatefulWidget {
  final double lat;
  final double lon;

  const MapViewStudent({Key key, this.lat, this.lon}) : super(key: key);

  @override
  _MapViewStudentState createState() => _MapViewStudentState();
}

class _MapViewStudentState extends State<MapViewStudent> {
  ...
  Widget build(BuildContext context) {
    ...
    print('_MapViewStudentState.initState ${widget.lat} - ${widget.lon}');
    if (widget.lat != null && widget.lon != null) {
      markers.add(Marker(
          ...
          icon: customIcon));
      setState(() {});
      animateCamera(Position(latitude: widget.lat, longitude: widget.lon));
    }
    return Container(
      height: height,
      width: width,
