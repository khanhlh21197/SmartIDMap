...
import 'package:smartid_map/ui/edit_ui/edit_user_dialog.dart';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          verticalLine(),
          buildTextLabel('Tên PH', 4),
          verticalLine(),
          buildTextLabel('Username', 2),
          verticalLine(),
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  verticalLine(),
                  buildTextData(parents[index].tenDecode ?? '', 4),
                  verticalLine(),
                  buildTextData(parents[index].maph ?? '', 2),
                  verticalLine(),
                  buildTextData(parents[index].nhaDecode ?? '', 2),
                ],
              ),
            ),
            horizontalLine(),
